...
class test_config_toml : public TestHarness {

 public:

  test_config_toml() {

    setTestDir("test_config_toml");

    resetArguments({
      "-c",             getTestDir() + "/settings.toml",
...
TEST_F(test_config_toml, overwriteArguments) {
