...
private:
  ...
  /* Domain boundary communication buffers    15个变量00000000000*/
...
public:
  ...
  /* Set _hex_num_groups */
  void setHexGroups(int hex_num_groups){ _hex_num_groups = hex_num_groups; }
  int getHexGroups(){ return _hex_num_groups;}
