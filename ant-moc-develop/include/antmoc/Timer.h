...
public:
  ...
  void recordSplit(const std::string &msg);
  void appendSplit(const std::string &msg, double time);
  double getTime();
  double getSplit(const std::string &msg);
  void printSplit(const std::string &msg, const std::string &caption,
                  int level = 0, const std::string &parent_split = "");
  void printSplit(const std::string &msg, int level = 0,
                  const std::string &parent_split = "");
  void printSplits();
  void clearSplit(const std::string &msg);
  void clearSplits();
