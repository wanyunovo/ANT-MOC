...
protected:
  ...
  /** Count referring to the segment number 线段数量的计数*/
  int _count;

  /** Maximum optical path length when forming segments 最大光学长度*/
  FP_PRECISION _max_tau;

  /** Number of energy groups in the current problem  能群数*/
  int _num_groups;
